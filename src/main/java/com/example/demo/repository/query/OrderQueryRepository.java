...
public class OrderQueryRepository {
	...
	public List<OrdrerFlatDto> findAllByDto_flat() {
		
		return em.createQuery("select new"+
				" com.example.demo.repository.query.OrdrerFlatDto(o.id,m.name,o.orderDate, o.status, d.address,i.name,oi.orderPrice,oi.count)" +
				" from Order o"+
				" join o.member m" +
				" join o.delivery d" +
				" join o.orderItems oi" +
				" join oi.item i", OrdrerFlatDto.class).getResultList();
	}
